...
// application name
export const APP_NAME = 'SELISE Wallet'
...
export const COMPANY_NAME = 'SELISE'

// logo of a company built application
export const COMPANY_LOGO = require('../../assets/icon.png')

// default user avatar placeholder
export const DEFAULT_USER_AVATAR = require('../../assets/icon.png')
